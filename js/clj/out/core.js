...
if(typeof core.state !== 'undefined'){
} else {
core.state = cljs.core.atom.call(null,(function (){var x__3686__auto__ = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sheet","sheet",-2059155794),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"crocodile","crocodile",-489076971),(0),new cljs.core.Keyword(null,"elephant","elephant",-1725469300),(0),new cljs.core.Keyword(null,"lion","lion",1707241445),(0)], null),new cljs.core.Keyword(null,"animal","animal",-1445940363),new cljs.core.Keyword(null,"lion","lion",1707241445),new cljs.core.Keyword(null,"dice","dice",707777434),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),(1)], null)], null);
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__3686__auto__);
})());
}
core.mark = (function core$mark(states,dice,animal){
var next_sheet = cljs.core.update.call(null,new cljs.core.Keyword(null,"sheet","sheet",-2059155794).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,states)),animal,cljs.core.inc);
var next_state = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sheet","sheet",-2059155794),next_sheet,new cljs.core.Keyword(null,"dice","dice",707777434),dice,new cljs.core.Keyword(null,"animal","animal",-1445940363),animal], null);
return cljs.core.conj.call(null,states,next_state);
});
...
return cljs.core.clj__GT_js.call(null,cljs.core.swap_BANG_.call(null,core.state,core.mark,dice,a));
});
